...
define(function (require, exports, module)
{
	...
	var pause_fns={	
		...
		pause_on:	function ()
		{
			...
			objects.oPause.style.background='url(img/game_plan/game_pause_hl.png) 0 0  no-repeat';
		...
		pause_off:	function ()
		{
			...
			objects.oPause.style.background='url(img/game_plan/game_pause.png) 0 0  no-repeat';
	...
	var fly_fns={
		...
		Fly:	function ()
		{
			this.hero_fly=['img/game_plan/hero_fly_1.png', 'img/game_plan/hero_fly_2.png'];
			
			this.enemy1_fly=['img/game_plan/enemy1_fly_1.png'];
			
			this.enemy2_fly=['img/game_plan/enemy2_fly_1.png', 'img/game_plan/enemy2_fly_2.png'];
			
			this.enemy3_fly=['img/game_plan/enemy3_fly_1.png'];
	...
	var blowup_fns={
		...
		Blowup_bg:	function ()
		{
			this.hero_blowup=['img/game_plan/hero_blowup_1.png', 'img/game_plan/hero_blowup_2.png', 'img/game_plan/hero_blowup_3.png', 'img/game_plan/hero_blowup_4.png'];
			
			this.enemy1_blowup=['img/game_plan/enemy1_blowup_1.png', 'img/game_plan/enemy1_blowup_2.png', 'img/game_plan/enemy1_blowup_3.png', 'img/game_plan/enemy1_blowup_4.png'];
			
			this.enemy2_blowup=['img/game_plan/enemy2_blowup_1.png', 'img/game_plan/enemy2_blowup_2.png', 'img/game_plan/enemy2_blowup_3.png', 'img/game_plan/enemy2_blowup_4.png', 'img/game_plan/enemy2_blowup_5.png', 'img/game_plan/enemy2_blowup_6.png', 'img/game_plan/enemy2_blowup_7.png'];
			
			this.enemy3_blowup=['img/game_plan/enemy3_blowup_1.png', 'img/game_plan/enemy3_blowup_2.png', 'img/game_plan/enemy3_blowup_3.png', 'img/game_plan/enemy3_blowup_4.png'];
		},
