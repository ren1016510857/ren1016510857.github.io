		...
		modularAct:	function ()
		{
			...
			var innerHTML=[
						...
						[
							...
							'	<li><img src="img/modular/accordion_0/bg4.jpg"><p>小狗狗</p></li>'+
							'	<li><img src="img/modular/accordion_0/bg5.jpg"><p>萌兔们</p></li>'+
							'</ul>'
						],
						...
						[
							'<div class="apple_8">'+
							'	<img src="img/modular/apple_8/1.png" width="64" />'+
							'	<img src="img/modular/apple_8/2.png" width="64" />'+
							'	<img src="img/modular/apple_8/3.png" width="64" />'+
							'	<img src="img/modular/apple_8/4.png" width="64" />'+
							'</div>'
						],
						...
						[
							...
							'</ol>'+
							'<ul>'+
							'	<li><a href="javascript:;"><img src="img/modular/accordion_0/bg0.jpg" alt="广告一" /></a></li>'+
							'	<li><a href="javascript:;"><img src="img/modular/accordion_0/bg1.jpg" alt="广告二" /></a></li>'+
							'	<li><a href="javascript:;"><img src="img/modular/accordion_0/bg2.jpg" alt="广告三" /></a></li>'+
							'	<li><a href="javascript:;"><img src="img/modular/accordion_0/bg3.jpg" alt="广告四" /></a></li>'+
							'	<li><a href="javascript:;"><img src="img/modular/accordion_0/bg4.jpg" alt="广告五" /></a></li>'+
							'</ul>'+
							'</div>'
						],
						//3D图片环
						[
							'<a id="demo" href="html/demo.html" target="_blank"><img src="img/modular/demo.jpg"/></>'
						]
			...
			var imgSrc=[
					'img/modular/clock_1/showImg.png',
					'img/modular/chrome_2/showImg.png',
					'img/modular/mousemove_3/showImg.png',
					'img/modular/calendar_4/showImg.png',
					'img/modular/drag_resize_5/showImg.png',
					'img/modular/scrollBar_6/showImg.png',
					'img/modular/associate_7/showImg.png',
					'img/modular/apple_8/showImg.png',
					'img/modular/flex_nav_9/showImg.png',
					'img/modular/flex_move_10/showImg.png',
					'img/modular/nogaprun_11/showImg.png',
					'img/modular/demo.jpg'
			];
			...
			var aHidePos=[{left: 415, top: 510}, {left: 465, top: 510},{left: 515, top: 510}];
