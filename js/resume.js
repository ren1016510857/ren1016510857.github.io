	...
	module.exports={
						resume:	function ()
						{
							var str='<div id="resume">'+
									...
									//自我介绍
									'<div class="resume_head"><img src="img/resume/head.jpg" alt="" /></div>'+
									'<div class="myInfo">'+
										'<h3>自我介绍</h3>'+
										'<ul class="clearfix">'+
											'<li class="smWidth">姓名： 任豪杰</li>'+
											'<li>性别:<em></em>男</li>'+
											'<li class="smWidth">年龄:<em></em>23</li>'+
											'<li>学历:<em></em>全日制本科</li>'+
											'<li class="smWidth">学校:<em></em>安阳工学院</li>'+
											'<li>专业:<em></em>电气工程及其自动化</li>'+
											'<li class="smWidth">毕业时间:<em></em>2015-07</li>'+
											'<li>QQ:<em></em> 1016510857</li>'+
											'<li class="smWidth">手机:<em></em><span>136-9148-0558</span></li>'+
											'<li>邮箱:<em></em><span>13691480558@163.com</span></li>'+
										'</ul>'+
										'<h3>求职意向</h3>'+
										'<ul class="clearfix">'+
											'<li>前端开发工程师</li>'+
									...
									'	<li class="resume_time">2011.09--2015.07<span class="timeaxis_line"></span><span class="timeaxis_contLine"></span><ul class="timeaxis_cont">'+
									'<li>学历：全日制本科</li>'+
									'<li>学校：安阳工学院</li>'+
									'<li>专业：电气工程及其自动化</li>'+
									'</ul></li>'+
									'	<li class="resume_time">2014.08--2015.1<span class="timeaxis_line"></span><span class="timeaxis_contLine"></span><ul class="timeaxis_cont">'+
									'<li>思考、学习</li>'+
									'<li>学习：前端开发</li>'+
									'</ul></li>'+
									'	<li class="resume_time">2015.04--2016.04<span class="timeaxis_line"></span><span class="timeaxis_contLine"></span><ul class="timeaxis_cont">'+
									'<li>公司：杭州微洽科技有限公司</li>'+
									'<li>职位：前端开发工程师</li>'+
									'</ul></li>'+
									'	<li class="resume_time">2016.04--至今<span class="timeaxis_contLine"></span><ul class="timeaxis_cont">'+
									'<li>求职</li>'+
									'<li>意向职位：前端开发</li>'+
									'</ul></li>'+
									'</ul>'+
